...
结果：This is [an example][id] reference-style link.
...
结果：[id]: http://example.com/  "Optional Title Here"
链接内容定义的形式为：
...
结果：[Google]: http://google.com/
由于链接文字可能包含空白，所以这种简化型的标记内也许包含多个单词：

	Visit [Daring Fireball][] for more information.

结果：Visit [Daring Fireball][] for more information.
然后接着定义链接：

	[Daring Fireball]: http://daringfireball.net/

结果：[Daring Fireball]: http://daringfireball.net/
...
结果：\*this text is surrounded by literal asterisks\*
<h3 id="code">代码</h3>
...
结果： ``There is a literal backtick (`) here.``
这段语法会产生：
...
结果：Please don't use any `<blink>` tags.
转为：
...
结果： [id]: url/to/image  "Optional title attribute"
